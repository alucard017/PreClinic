...
<body>
	...
	<div class="super_container">
		...
		<div class="home">
			<div class="background_image" style="background-image:url(images/doctorhome3.jpg)"></div>
			<div class="home_container">
				<div class="container">
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_subtitle">#1 Solution to all your Health Problems</div>
								<div class="home_title"></div>
								<div class="home_text">
									<p>We are the brave researchers and countellersWe are what we do
										When we deny the story, it defines us. When we OWN THE STORY, we can write a
										brave new ending. We are the brave researchers and countellersWe are what we do
										When we deny the story, it defines us. When we OWN THE STORY, we can write a
										brave new ending. Diversity mattersUnity in Diversity.
										It is our job to remove the invisible barrier between people with different
										backgrounds</p>
								</div>
							</div>
						</div>
				...
				<div class="row row-eq-height">
					...
					<div class="col-lg-6 order-lg-2 order-1">
						<div class="why_content">
							...
							<div class="why_text">
								<p>We Care as like your family. Everyone is entitled to care and dignityHealthcare is
									not only what we do
									Everyone deserves respect, equality, safety, and security. Research and health data
									can change lives and industries but
									should never be done at the expense of our member’s privacy. Community insights are
									valuableWe Define a broad community.
									In a world oversaturated with news, articles, opinions, and stories about health, we
									help our community better
									understand a range of health topics.</p>
							</div>
							<div class="why_list">
								<ul>
									...
									<li class="d-flex flex-row align-items-center justify-content-start">
										<div
											...
											<div class="icon"><img src="images/icon_1.svg"
													alt="https://www.flaticon.com/authors/prosymbols"></div>
										</div>
										<div class="why_list_content">
											<div class="why_list_title">Only Top Works</div>
											<div class="why_list_text">Our work is perfect and as accurate as offline
												environment.</div>
										</div>
									</li>
									...
									<li class="d-flex flex-row align-items-center justify-content-start">
										<div
											class="icon_container d-flex flex-column align-items-center justify-content-center">
											<div class="icon"><img src="images/icon_2.svg"
													alt="https://www.flaticon.com/authors/prosymbols"></div>
										</div>
										<div class="why_list_content">
											<div class="why_list_title">The best Doctors</div>
											<div class="why_list_text">We engage you with the best doctors, with a
												selection to choose your doctor.</div>
										</div>
									</li>
									...
									<li class="d-flex flex-row align-items-center justify-content-start">
										<div
											class="icon_container d-flex flex-column align-items-center justify-content-center">
											<div class="icon"><img src="images/icon_3.svg"
													alt="https://www.flaticon.com/authors/prosymbols"></div>
										</div>
										<div class="why_list_content">
											<div class="why_list_title">Great Feedback</div>
											<div class="why_list_text">We have a great customer feedback also has a
												satisfactory user service.</div>
										</div>
									</li>
