...
<head>
	...
	<link rel="icon" type="image/x-icon" href="images/favicon5.png">
</head>
					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								...
								<div class="home_text">Our Door is always open to welcome you to the world of
									Extensive Healthcare. </div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="contact_form_container">
							...
							<form action="apurbasundar2002@yahoo.com" class="contact_form" id="contact_form">
								<div class="d-flex flex-row align-items-start justify-content-between flex-wrap">
									...
									<input type="email" class="contact_input" placeholder="Your E-mail"
										required="required">
									<input type="tel" class="contact_input" placeholder="Your Phone"
										required="required">
									...
									<input type="text" id="datepicker" class="contact_input datepicker"
					...
					<div class="col-lg-5 offset-lg-1 contact_col">
						<div class="contact_content">
							...
							<div class="contact_content_text">
								<p>We are on non-profit, we work for you. Our job is to empower and encourage everyone
									with a health condition to speak
									about their experiences and advance healthcare. We work to make sure you have a
									voice at the table..</p>
							</div>
							<div class="direct_line d-flex flex-row align-items-center justify-content-start">
								...
								<div class="direct_line_num text-center">+91 123 456 7890</div>
							</div>
							<div class="contact_info">
								<ul>
									<li class="d-flex flex-row align-items-start justify-content-start">
										<div>Address</div>
										<div>Ravenshaw Hospital, Cuttack, Odisha, 753004</div>
									</li>
									<li class="d-flex flex-row align-items-start justify-content-start">
										<div>Phone</div>
