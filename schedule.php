            ...
            <div class="col-md-12">
                <div class="table-responsive">
                    <table class="table table-border table-striped custom-table mb-0">
                        ...
                        <tbody>
                        <?php 
                            $query=mysqli_query($con,"SELECT doctorSchedule.*,doctors.*,doctorSchedule.status as scheduleStatus FROM doctorSchedule,doctors where doctorSchedule.doctorId=doctors.id");
                            while($list=mysqli_fetch_assoc($query)){
                        ?>
                            <tr>
                                <td><img width="28" height="28" src="assets/img/user.jpg" class="rounded-circle m-r-5"
                                        alt=""><?php echo $list['dfName'].' '.$list['dlName'] ?></td>
                                <td><?php echo $list['availableDays'] ?></td>
                                <td><?php echo $list['startTime'] .'-'.  $list['endTime'] ?></td>
                                <td><span
                                        class="custom-badge status-<?php echo $list['scheduleStatus']==0?"red":"green" ?>"><?php echo $list['scheduleStatus']==0?"Inactive":"Active" ?></span>
                                </td>
                                <td class="text-right">
